...
MODEL="Qwen2Model"
CONFIG="workload_config/qwen2-subset/"
PREC="bf16"
BATCH="1 4 8"
SEQLEN="128 1024 2048 4096 8192"
MODE="prefill"
BACKEND="sdpa"
...
CMD="${CMD} --model_type ${MODEL_TYPE} --model ${MODEL} --config_folder ${CONFIG} --precision ${PREC} --batch ${BATCH} --seqlen ${SEQLEN} --mode ${MODE} --attn_backend ${BACKEND}"
